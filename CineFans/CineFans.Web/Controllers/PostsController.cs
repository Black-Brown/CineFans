...
namespace CineFans.Web.Controllers
{
    public class PostsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PostId,UserId,MovieId,Text,Date")] Post posts)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PostId,UserId,MovieId,Text,Date")] Post posts)
        {
            if (id != posts.PostId)
            {
                return NotFound();
